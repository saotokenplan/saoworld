...
RequireMessagesReadScope = require_scope(Scope.MESSAGES_READ)
RequireMessagesWriteScope = require_scope(Scope.MESSAGES_WRITE)
RequireGuildReadScope = require_scope(Scope.GUILD_READ)
RequireGuildWriteScope = require_scope(Scope.GUILD_WRITE)
RequireSocialReadScope = require_scope(Scope.SOCIAL_READ)
RequireGuildWarReadScope = require_scope(Scope.GUILD_WAR_READ)
RequireGuildWarWriteScope = require_scope(Scope.GUILD_WAR_WRITE)
RequireCollabQuestReadScope = require_scope(Scope.COLLAB_QUEST_READ)
RequireCollabQuestWriteScope = require_scope(Scope.COLLAB_QUEST_WRITE)
RequireEconomyReadScope = require_scope(Scope.ECONOMY_READ)
RequireMatchReadScope = require_scope(Scope.MATCH_READ)
RequireMatchWriteScope = require_scope(Scope.MATCH_WRITE)
RequireMatchOpsScope = require_scope(Scope.MATCH_OPS)
