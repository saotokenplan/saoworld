...
RequireContentReadScope = require_scope(Scope.CONTENT_READ)
RequireContentReleaseScope = require_scope(Scope.CONTENT_RELEASE)
RequireContentRollbackScope = require_scope(Scope.CONTENT_ROLLBACK)
RequireReviewApproveScope = require_scope(Scope.REVIEW_APPROVE)
