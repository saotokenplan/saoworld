...
class VoteErrorCodes:
    ...
    DISCUSSION_CONTENT_TOO_LONG = "DISCUSSION_CONTENT_TOO_LONG"
    DISCUSSION_CONTENT_EMPTY = "DISCUSSION_CONTENT_EMPTY"
    INVALID_VOTE_CYCLE_FOR_DISCUSSION = "INVALID_VOTE_CYCLE_FOR_DISCUSSION"
